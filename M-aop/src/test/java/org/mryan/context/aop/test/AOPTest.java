package org.mryan.context.aop.test;

import org.junit.Test;
import org.mryan.context.ClassPathXmlApplicationContext;
import org.mryan.context.aop.*;
import org.mryan.context.aop.advice.AdvisedSupport;
import org.mryan.context.aop.advice.TargetSource;
import org.mryan.context.aop.test.context.ClassService;
import org.mryan.context.aop.test.context.IClassService;
import org.mryan.context.aop.test.interceptor.ClassServiceInterceptor;
...
public class AOPTest {
    ...
    public void TEST_AOP_ASPECT_JEXPRESSION_POINTCUT() throws NoSuchMethodException {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut("execution(* org.mryan.context.aop.test.context.IClassService.*(..))");
    ...
    public void TEST_PROXY_METHOD() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* org.mryan.context.aop.test.context.IClassService.*(..))"));
